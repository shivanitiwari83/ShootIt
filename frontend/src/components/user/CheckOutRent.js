              ...
              <div className="card-body p-4">
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <h1 className="mb-3">{equipmentData.title}</h1>
                    <label>
                      <b>Novel Author</b>
                    </label>
                    <h3 className="mb-3">{equipmentData.author}</h3>
                    <label>
                      <b>Novel Publisher</b>
                    </label>
                    <h3 className="mb-3">{equipmentData.publisher}</h3>
                    <label>
                      <b>Novel RentPrice</b>
                    </label>
                    <h3 className="mb-3">{equipmentData.rentPrice}</h3>
                    <label>
                      <b>Novel SellPrice</b>
                    </label>
                  ...
                  <div className="col-md-6">
                    ...
                    <img  className="img-fluid w-100"
                     src={url + "/" + equipmentData.image} alt="" />
